...
class Wps {
	 ...
	 *
	 * - Wps_Loader. Orchestrates the hooks of the plugin.
	 * - Wps_i18n. Defines internationalization functionality.
	 * - Wps_Admin. Defines all hooks for the admin area.
	 * - Wps_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wps-i18n.php';
	 ...
	 *
	 * Uses the Wps_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
